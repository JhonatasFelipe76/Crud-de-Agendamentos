package com.github.agendador_horarios.services;

import com.github.agendador_horarios.infrastructure.entity.Agendamento;
import com.github.agendador_horarios.infrastructure.repository.AgendamentoRepository;
...
public class AgendamentoService {
    ...
    public Agendamento alterarAgendamento(Agendamento agendamento, String cliente, LocalDateTime dataHoraAgendamento){
        ...
        //Se o agendamento não existir ele retorna a mensagem:
        if(Objects.isNull(agenda)){
            throw new RuntimeException("O horário não está preenchido");
        }
        //Se o agendamento existe ele Altera o agendamento
